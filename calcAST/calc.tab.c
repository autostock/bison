...
static const char *const yytname[] =
{
  ...
  "T_NEWLINE", "T_QUIT", "$accept", "calculation", "line", "expression",
  "number", "eol", YY_NULLPTR
};
...
{
      18,    -6,    -6,    -6,    -2,    -6,    28,    -6,     9,    -6,
      -6,    35,    -6,    -6,    -2,    -2,    -2,    -2,    -6,    -6,
      -3,    -3,    -6,    -6
};
...
{
       0,    15,    12,    13,     0,    14,     0,     2,     0,     6,
       4,     0,    15,     3,     0,     0,     0,     0,     5,    11,
       7,     8,     9,    10
};
...
{
      11,     2,     3,    18,    16,    17,    13,     4,     0,     1,
      20,    21,    22,    23,    14,    15,    16,    17,     1,     0,
       5,     2,     3,     0,     0,     0,     0,     4,    12,     5,
       0,     2,     3,     0,     0,     0,     0,     4,     0,     5,
      14,    15,    16,    17,     0,    19
};
...
{
       4,     3,     4,     8,     7,     8,     6,     9,    -1,     0,
      14,    15,    16,    17,     5,     6,     7,     8,     0,    -1,
      11,     3,     4,    -1,    -1,    -1,    -1,     9,     0,    11,
...
{
       0,     0,     3,     4,     9,    11,    14,    15,    16,    17,
      18,    16,     0,    15,     5,     6,     7,     8,    18,    10,
      16,    16,    16,    16
};
...
#line 42 "calc.y"
                  { (yyval.node) = (yyvsp[0].node); root=(yyval.node); SHOW("line", (yyval.node)); }
#line 1102 "calc.tab.c"
    break;

  case 3: /* calculation: calculation line  */
#line 43 "calc.y"
                              { (yyval.node) = malloc(sizeof(Node)); root=(yyval.node); (yyval.node)->OpCode='#'; (yyval.node)->left=(yyvsp[-1].node); (yyval.node)->right=(yyvsp[0].node); SHOW("calculation line", (yyval.node)); }
#line 1108 "calc.tab.c"
    break;

  case 7: /* expression: expression T_PLUS expression  */
#line 51 "calc.y"
                                                { (yyval.node) = malloc(sizeof(Node)); (yyval.node)->OpCode='+'; (yyval.node)->left=(yyvsp[-2].node); (yyval.node)->right=(yyvsp[0].node); SHOW("e+e", (yyval.node)); }
#line 1114 "calc.tab.c"
    break;

  case 8: /* expression: expression T_MINUS expression  */
#line 52 "calc.y"
                                                { (yyval.node) = malloc(sizeof(Node)); (yyval.node)->OpCode='-'; (yyval.node)->left=(yyvsp[-2].node); (yyval.node)->right=(yyvsp[0].node); }
...
#line 1132 "calc.tab.c"
  ...
  case 11: /* expression: T_LEFT expression T_RIGHT  */
#line 55 "calc.y"
                                                { (yyval.node) = (yyvsp[-1].node); }
#line 1138 "calc.tab.c"
    break;

  case 12: /* number: T_INT  */
#line 58 "calc.y"
                                        { (yyval.node) = malloc(sizeof(Node)); (yyval.node)->OpCode='i'; (yyval.node)->ival=(yyvsp[0].ival); }
#line 1144 "calc.tab.c"
    break;

  case 13: /* number: T_FLOAT  */
#line 59 "calc.y"
                                                { (yyval.node) = malloc(sizeof(Node)); (yyval.node)->OpCode='f'; (yyval.node)->fval=(yyvsp[0].fval); }
